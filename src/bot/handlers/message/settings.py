...
from src.bot.utils import get_username_from_update, get_user_from_db
...
async def handle_settings(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user is None:
        logger.bind(username="system").warning("Received reconfigure setting request but effective_user is None")
        return
